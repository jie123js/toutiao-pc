      ...
      <el-row :gutter="10">
        ...
        >
          ...
          <div
            ...
            "
          >
            <el-button size="small" type="warning" circle="" :class="{'el-icon-star-on':item.is_collected,'el-icon-star-off':!item.is_collected}"  :disabled=item.load @click="changeCol(item)"></el-button>
            <el-button @click="deleteImage(item)" size="small" type="danger" class="el-icon-delete" circle="" :disabled=item.load></el-button>
          </div>
        </el-col>
      </el-row>
      <el-pagination
